...
public class OrePopulator extends BlockPopulator {
	...
	public void populate(World world, Random random, Chunk source) {
		...
		int[] iterations = new int[] { 10, 20, 20, 2, 8, 1, 1, 1, 30, 20 };
		int[] amount = new int[] { 32, 16, 8, 8, 7, 7, 6, 32, 32 };
		Material[] type = new Material[] { Material.GRAVEL, Material.COAL_ORE, Material.IRON_ORE, Material.GOLD_ORE, Material.REDSTONE_ORE, Material.DIAMOND_ORE, Material.LAPIS_ORE, Material.DIRT,
				Material.CLAY };
		int[] maxHeight = new int[] { 128, 128, 128, 128, 128, 64, 32, 16, 16, 32, 64, 64 };
